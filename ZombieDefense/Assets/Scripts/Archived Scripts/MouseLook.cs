...
{
    //GOAT TUTORIAL https://www.youtube.com/watch?v=Coch-PkHY54&ab_channel=NedMakesGames
    ...
    private float ClampVerticalAngle(float angle) { return Mathf.Clamp(angle, -maxVerticalAngleFromHorizon, maxVerticalAngleFromHorizon); }    
}
